...
function DataCard (parent, data = new Object ({}), id = null) {
	// Attributes.
	let opts_id = null, tt_id = null, ci_id = null, hdr_id = null, cd_id = null, in_id = null, opts_ids = [], big_data = {};
	...
	this.visibility = (visible, finished = null) => {
		...
		if (!visible) $ (cd_id).animate ({opacity: 0}, 300, function () {
			// Called the passed method when the widget is destroyed.
			if (typeof finished === "function") finished (); $ (this).css ("display", "none").remove ();
		// Otherwise.
		}); else $ (cd_id).css ("display", "inline-block").animate ({opacity: 1}, 300, () => {
