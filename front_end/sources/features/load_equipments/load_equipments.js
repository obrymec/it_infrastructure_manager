	...
	if (typeof item === "object" && toolbar instanceof CrudView) {
		...
		if (window.eq_tc.get_active_section () === 0) eq_card.override_options ([
			{text: "Historical", title: "Consult the history of this equipment.", click: () => {
				...
				sup_popup (
					"./sources/features/select_service/select_service.html",
					820, 480, 1024, 600, "de service",
					["svc_slt_crud", "selected_equipment"],
				...
				sup_popup ("./sources/features/select_user/select_user.html", 680, 480, 1024, 600, "of a user",
...
function load_availables_equipments () {
	...
	load_view (
		"./sources/features/available_equipments/available_equipments.html",
		window.eq_tc.get_tab_content_id (),
		window.MESSAGES [2],
		window.MESSAGES [3]
	);
...
function load_bug_equipments () {
	...
	load_view (
		"./sources/features/maintenance_equipments/maintenance_equipments.html",
		window.eq_tc.get_tab_content_id (),
		window.MESSAGES [2],
		window.MESSAGES [3]
	);
...
function load_service_equipments () {
	...
	load_view (
		"./sources/features/service_equipments/service_equipments.html",
		window.eq_tc.get_tab_content_id (),
		window.MESSAGES [2],
		window.MESSAGES [3]
	);
