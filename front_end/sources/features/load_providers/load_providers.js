...
function load_good_providers () {
	...
	load_view (
		"./sources/features/good_providers/good_providers.html",
		window.prv_tc.get_tab_content_id (),
		window.MESSAGES [2],
		window.MESSAGES [3]
	);
...
function load_bad_providers () {
	...
	load_view (
		"./sources/features/bad_providers/bad_providers.html",
		window.prv_tc.get_tab_content_id (),
		window.MESSAGES [2],
		window.MESSAGES [3]
	);
