...
function load_availables_services () {
	...
	load_view (
		"./sources/features/available_services/available_services.html",
		window.svc_tc.get_tab_content_id (),
		window.MESSAGES [2],
		window.MESSAGES [3]
	);
...
function load_running_services () {
	...
	load_view (
		"./sources/features/running_services/running_services.html",
		window.svc_tc.get_tab_content_id (),
		window.MESSAGES [2],
		window.MESSAGES [3]
	);
...
function load_expired_services () {
	...
	load_view (
		"./sources/features/expired_services/expired_services.html",
		window.svc_tc.get_tab_content_id (),
		window.MESSAGES [2],
		window.MESSAGES [3]
	);
